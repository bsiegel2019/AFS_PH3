					...
					<table class="table table-hover table-striped">
						...
						<tbody>
							<tr data-ng-repeat="drone in droneCtrl.drones">
								...
								<td>{{drone.droneFirstFlownDate | date: 'yyyy/MM/dd'}}</td>
								<td>{{drone.droneStatus}}</td>
								<td>{{drone.droneImage}}</td>
								<td>
									<button type="button" data-ng-click="droneCtrl.remove(drone.droneId)" class="btn btn-danger custom-width">Scrap</button>

									<button type="button" class="btn btn-info">
										<a data-ng-href="${contextPath}/droneComment/{{drone.droneId}}"><b>Comments</b></a>
									</button>
								</td>
							</tr>
						</tbody>
