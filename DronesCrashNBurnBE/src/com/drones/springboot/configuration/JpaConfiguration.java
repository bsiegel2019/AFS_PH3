package com.drones.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.drones.springboot.repositories", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.drones.springboot.model" });
